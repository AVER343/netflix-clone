...
export default function HeaderContainer({ children }:any) {
  ...
  return (
    <Header>
      <Header.Frame>
       ...
       {session ?
       <Header.ButtonLink onClick={()=>signOut()}>Logout</Header.ButtonLink>
       :<Header.ButtonLink onClick={()=>router.push('/login')}>Sign In</Header.ButtonLink>}
      </Header.Frame>
        {children}
    </Header>
  );
